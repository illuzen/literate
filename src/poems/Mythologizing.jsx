...
export default class Myth extends Poem {
    render() {
      return (
          <div>
          <Poem title='Mythologizing the Unconscious' author='illuzen' image={Devil} />
          <br/>
